...
- 评估采用 LLM-as-Judge 方法，围绕个性化命中、精准简洁、诚实性、可追溯性四个维度评分：`python eval/scripts/run_eval_stream.py --base-url http://127.0.0.1:9000 --concurrency 5 --report eval/reports/report_v2.json`（默认写 `eval/reports/answers.json`）。
